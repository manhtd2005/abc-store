        ...
        <div className="container mx-auto my-10 px-4 sm:px-6 lg:px-8">
            ...
            {cartItems.length === 0 ? (
                <div className="flex flex-col items-center justify-center p-10 bg-white rounded-lg shadow-lg text-center">
                    ...
                    <p className="text-gray-500 text-lg mb-4 font-semibold">Your cart is empty.</p>
                    <p className="text-gray-600 mb-6">Looks like you haven't added anything to your cart yet. Go ahead & explore some categories!</p>
                    <Link to="/collection" className="bg-gray-900 text-white px-8 py-3 rounded-lg hover:bg-gray-700 transition duration-300 transform hover:scale-105">
                        Start Shopping
                    </Link>
                </div>
            ) : (
                <div className="lg:flex lg:gap-8">
                    ...
                    <div className="lg:w-1/3 bg-white rounded-2xl shadow p-6 lg:mt-0 mt-8">
                        ...
                        <Link to="/collection" className="block text-center text-gray-600 mt-4 hover:text-gray-900 transition">
                            Continue Shopping
                        </Link>
                    </div>
                </div>
