...
const ProductDetail = () => {
  ...
  if (loading) {
    return <div className="text-center text-lg p-10">Loading product details...</div>;
  }

  if (!product) {
    return <div className="text-center text-red-500 p-10">Product not found!</div>;
  }

  return (
    <div className="container mx-auto my-10 px-4 sm:px-6 lg:px-8">
      <div className="bg-white rounded-3xl shadow-lg p-6 lg:flex lg:gap-8">
